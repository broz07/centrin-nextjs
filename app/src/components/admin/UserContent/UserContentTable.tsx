        ...
        <>
            ...
            <DialogContent>
              <FormControl fullWidth>
                ...
                <TextField
                  ...
                  fullWidth
                />
                <TextField margin="dense" id="role" label="Role" select fullWidth defaultValue={selectValue} required>
          ...
          <Dialog open={passwordOpen} onClose={handlePasswordClose}>
            ...
            <DialogActions>
              ...
              <Button variant="contained" endIcon={<PasswordIcon />} onClick={handleResetPassword}>
                Změnit heslo
              </Button>
            </DialogActions>
          </Dialog>
