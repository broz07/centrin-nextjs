...
const ConfirmDeleteDialog: React.FC<Props> = ({ open, close }) => {
    ...
    const handleDelete = async () => {
        ...
        if (deleted) {
            updateToast(toast, "Závada byla úspěšně smazána", NotificationType.SUCCESS, NotificationPosition.BR, 2000)
        } else {
            updateToast(toast, "Závada se nepodařilo smazat", NotificationType.ERROR, NotificationPosition.BR, 2000)
        }
